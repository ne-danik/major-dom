...
/* harmony default export */ var pagination = (function (Splide, Components, name) {
  ...
  function updateAttributes(index, prevIndex) {
    ...
    if (curr) {
      ...
      curr.button.innerHTML = circleLoader;
    }
...
const circleLoader = `<svg style="transform:rotate(-90deg)" width="18" height="18" viewBox="0 0 18 18" fill="none">
<circle class="loading" cx="9" cy="9" r="8.5" stroke="white"/></svg>`;
...
for (let i = 0; i < dots.length; i++) {
  ...
  dot.addEventListener('click', e => {
    ...
    e.target.innerHTML = circleLoader;
  })
}